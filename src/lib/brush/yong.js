    ...
    strokes: [
      {
        ...
        paths: [
          { timeEase: "linear", pressureEase: "linear", duration: 1, tension: 0.5,
            h1: { x: -0.3312762881868946, y: 0.2795370015837444 },
            h2: { x: -0.3083252366445143, y: 0.2534562590239807 } },
          { timeEase: "linear", pressureEase: "linear", duration: 1, tension: 0.5, h1: null, h2: null },
          { timeEase: "linear", pressureEase: "linear", duration: 1, tension: 0.5, h1: null, h2: null },
          { timeEase: "linear", pressureEase: "linear", duration: 1, tension: 0.5, h1: null, h2: null },
          { timeEase: "linear", pressureEase: "linear", duration: 1, tension: 0.5, h1: null, h2: null },
          { timeEase: "linear", pressureEase: "linear", duration: 1, tension: 0.5, h1: null, h2: null },
          { timeEase: "linear", pressureEase: "linear", duration: 1, tension: 0.5,
            h1: { x:  0.03585913487474077, y: -0.4561973746003149 },
            h2: { x:  0.0012224149316815772, y: -0.5016162828274658 } },
          { timeEase: "linear", pressureEase: "linear", duration: 1, tension: 0.5,
            h1: { x: -0.07216970543252033, y: -0.44894667323755333 },
            h2: { x: -0.09375859970683761, y: -0.4320509944309051 } },
        ],
      },
      {
        id: 46,
      ...
      },
      {
        ...
        paths: [
          ...
          { timeEase: "linear", pressureEase: "linear", duration: 1, tension: 0.5, h1: null, h2: null },
          { timeEase: "linear", pressureEase: "linear", duration: 1, tension: 0.5,
            h1: { x: -0.2073271173108842, y: -0.19592388092845747 },
            h2: { x: -0.3379516271332662, y: -0.2706813494146106 } },
        ],
      },
      {
        id: 56,
