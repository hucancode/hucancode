...
// 龍, 21 strokes
const int NSEG = 57;
const float TOTAL_TIME = 5.36004;
const Seg SEGS[NSEG] = Seg[NSEG](
    ...
    Seg(vec2(-0.39617, -0.19852), vec2(-0.21355, -0.07163), vec2(-0.308, -0.10338), 0.17, 0.35, 0.26, 0.56528, 1, 2.228, 0.09748, 4.0918, 1.16179),
    Seg(vec2(-0.21355, -0.07163), vec2(-0.42976, -0.36325), vec2(-0.29139, -0.17875), 0.35, 0.30952, 0.0, 0.36795, 1, 2.32548, 0.31391, 1.16179, 1.1512),
    Seg(vec2(-0.42976, -0.36325), vec2(-0.1923, -0.1503), vec2(-0.26117, -0.25603), 0.30952, 0.39, 0.28, 0.61607, 1, 2.63939, 0.15183, 1.1512, 3.5506),
    Seg(vec2(-0.1923, -0.1503), vec2(0.01139, 0.32307), vec2(-0.17824, -0.12871), 0.39, 0.16, 0.0, 0.04934, 1, 2.79122, 0.13472, 3.5506, 4.1164),
    Seg(vec2(0.01139, 0.32307), vec2(0.21306, 0.51728), vec2(0.06243, 0.41825), 0.16, 0.42, 0.0, 0.5, 0, 2.92595, 0.10377, 4.1164, 1.7242),
    Seg(vec2(0.21306, 0.51728), vec2(0.1417, 0.54319), vec2(0.19123, 0.52777), 0.42, 0.07, 0.18, 0.31858, 1, 3.02972, 0.02684, 1.7242, 4.3378),
    Seg(vec2(0.1417, 0.54319), vec2(-0.03231, 0.67847), vec2(-0.05822, 0.60545), 0.07, 0.04, 0.0, 0.75332, 1, 3.05655, 0.05986, 4.3378, 4.4116),
    Seg(vec2(-0.03231, 0.67847), vec2(0.02349, 0.62117), vec2(-0.04998, 0.65294), 0.04, 0.78, 0.0, 0.5, 0, 3.11641, 0.03069, 4.4116, 2.30154),
    Seg(vec2(0.02349, 0.62117), vec2(0.00413, 0.23437), vec2(0.0279, 0.45611), 0.78, 0.51, 0.34, 0.42848, 1, 3.1471, 0.15159, 2.30154, 2.83379),
    Seg(vec2(0.00413, 0.23437), vec2(0.03996, 0.20221), vec2(0.01683, 0.20941), 0.51, 0.41146, 0.0, 0.5, 0, 3.29869, 0.01902, 2.83379, 2.5138),
    Seg(vec2(0.03996, 0.20221), vec2(0.20674, 0.32683), vec2(0.11709, 0.26253), 0.41146, 0.64, 0.0, 0.5, 0, 3.31771, 0.08236, 2.5138, 2.54294),
    Seg(vec2(0.20674, 0.32683), vec2(0.2576, 0.31313), vec2(0.24657, 0.33362), 0.64, 0.41, 0.0, 0.5, 0, 3.40006, 0.02831, 2.54294, 1.73129),
    Seg(vec2(0.2576, 0.31313), vec2(0.07866, 0.11058), vec2(0.17181, 0.2129), 0.41, 0.47, 0.25, 0.49107, 1, 3.42837, 0.11018, 1.73129, 3.35269),
    Seg(vec2(0.07866, 0.11058), vec2(0.04128, 0.0718), vec2(0.04045, 0.07713), 0.47, 0.54102, 0.0, 0.5, 0, 3.53855, 0.02799, 3.35269, 1.02829),
    Seg(vec2(0.04128, 0.0718), vec2(0.33085, 0.20655), vec2(0.18461, 0.13906), 0.54102, 0.45, 0.0, 0.5, 0, 3.56654, 0.24419, 1.02829, 1.63415),
    Seg(vec2(0.33085, 0.20655), vec2(0.32829, 0.17053), vec2(0.37861, 0.18307), 0.45, 0.13, 0.0, 0.5, 0, 3.81073, 0.03096, 1.63415, 4.1902),
    Seg(vec2(0.32829, 0.17053), vec2(-0.04237, 0.02277), vec2(-0.03955, 0.0789), 0.13, 0.15, 0.0, 0.89089, 1, 3.84169, 0.10053, 4.1902, 4.141),
    Seg(vec2(-0.04237, 0.02277), vec2(0.00582, -0.02511), vec2(-0.00616, 0.00543), 0.15, 0.62, 0.0, 0.5, 0, 3.94222, 0.0211, 4.141, 2.707),
    Seg(vec2(0.00582, -0.02511), vec2(0.02425, -0.46151), vec2(0.01082, -0.24008), 0.62, 1.0, 0.84, 0.49416, 1, 3.96332, 0.1957, 2.707, 1.81646),
    Seg(vec2(0.02425, -0.46151), vec2(0.17362, -0.58684), vec2(0.08442, -0.5433), 1.0, 0.68569, 0.0, 0.5, 0, 4.15902, 0.09187, 1.81646, 2.55168),
    Seg(vec2(0.17362, -0.58684), vec2(0.54038, -0.5643), vec2(0.34484, -0.62645), 0.68569, 0.72, 0.94, 0.46279, 1, 4.25089, 0.14616, 2.55168, 2.59543),
    Seg(vec2(0.54038, -0.5643), vec2(0.66, -0.47974), vec2(0.61576, -0.53636), 0.72, 0.45953, 0.0, 0.5, 0, 4.39704, 0.0551, 2.59543, 2.86119),
    Seg(vec2(0.66, -0.47974), vec2(0.65309, -0.11304), vec2(0.67116, -0.32527), 0.45953, 0.14, 0.24, 0.41746, 1, 4.45214, 0.10582, 2.86119, 4.1656),
    Seg(vec2(0.65309, -0.11304), vec2(0.04084, -0.05722), vec2(0.60357, 0.46891), 0.14, 0.05, 0.0, 0.41545, 1, 4.55796, 0.26138, 4.1656, 4.387),
    Seg(vec2(0.04084, -0.05722), vec2(0.05986, -0.10274), vec2(0.02213, -0.09387), 0.05, 0.49787, 0.0, 0.5, 0, 4.81934, 0.02188, 4.387, 2.23114),
    Seg(vec2(0.05986, -0.10274), vec2(0.275, -0.03323), vec2(0.20845, -0.05549), 0.49787, 0.57, 0.54, 0.68713, 1, 4.84123, 0.08571, 2.23114, 3.0911),
    Seg(vec2(0.275, -0.03323), vec2(0.33795, -0.02455), vec2(0.31282, -0.02636), 0.57, 0.14, 0.58, 0.60122, 1, 4.92694, 0.01766, 3.0911, 4.1656),
    Seg(vec2(0.33795, -0.02455), vec2(0.03691, -0.21456), vec2(0.3557, -0.02327), 0.14, 0.17, 0.0, 0.01762, 1, 4.9446, 0.08907, 4.1656, 4.0918),
    Seg(vec2(0.03691, -0.21456), vec2(0.06964, -0.23681), vec2(0.04478, -0.22949), 0.17, 0.48, 0.0, 0.5, 0, 5.03367, 0.01202, 4.0918, 2.90566),
    Seg(vec2(0.06964, -0.23681), vec2(0.30633, -0.16775), vec2(0.18704, -0.20296), 0.48, 0.56, 0.44, 0.49667, 1, 5.04569, 0.08283, 2.90566, 3.04898),
    Seg(vec2(0.30633, -0.16775), vec2(0.36171, -0.1738), vec2(0.34157, -0.16765), 0.56, 0.17, 0.38, 0.62555, 1, 5.12851, 0.01582, 3.04898, 4.0918),
    Seg(vec2(0.36171, -0.1738), vec2(0.04432, -0.31371), vec2(0.3783, -0.17887), 0.17, 0.12, 0.0, 0.01885, 1, 5.14433, 0.0862, 4.0918, 4.2148),
    Seg(vec2(0.04432, -0.31371), vec2(0.06345, -0.35586), vec2(0.04425, -0.33906), 0.12, 0.46, 0.0, 0.5, 0, 5.23054, 0.01523, 4.2148, 2.41787),
    Seg(vec2(0.06345, -0.35586), vec2(0.31396, -0.29524), vec2(0.19084, -0.32389), 0.46, 0.59665, 0.5, 0.50718, 1, 5.24577, 0.09557, 2.41787, 2.99649),
    Seg(vec2(0.31396, -0.29524), vec2(0.38286, -0.29916), vec2(0.35597, -0.29451), 0.59665, 0.0, 0.49, 0.60306, 1, 5.34134, 0.01869, 2.99649, 4.51)
);
// ===== end baked data =====
