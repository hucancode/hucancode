...
function setCubeSize(size) {
  cubeNum = Math.max(1, Math.min(10, size));
}
...
function init(customCanvasId = "rubik3r") {
...
export { init, destroy, render, getCurrentSize, remakeRubik, setCubeSize };
