<script>
  ...
  const JOINT_CTL = {
    hinge1: [["jaw", "clevis jaw", 0.1, 0.6], ["lugT", "lug thickness", 0.05, 0.3], ["lugL", "lug length", 0.3, 1.2], ["lugD", "lug depth", 0.2, 1.2], ["pinR", "pin radius", 0.06, 0.24], ["pinOut", "pin overhang", 0, 0.2], ["flangeT", "flange thickness", 0.08, 0.5], ["clr", "lug clearance", 0.004, 0.08], ["tang", "solid tang", 0, 1, 1], ["discF", "clevis disc flange", 0, 1, 1], ["discM", "tang disc flange", 0, 1, 1]],
    hinge2: [["jaw", "clevis jaw", 0.1, 0.6], ["lugT", "lug thickness", 0.05, 0.3], ["lugL", "lug length", 0.3, 1.2], ["lugD", "lug depth", 0.2, 1.2], ["pinR", "pin radius", 0.06, 0.24], ["pinOut", "pin overhang", 0, 0.2], ["flangeT", "flange thickness", 0.08, 0.5], ["clr", "lug clearance", 0.004, 0.08], ["tang", "solid tang", 0, 1, 1], ["discF", "top disc flange", 0, 1, 1], ["discMid", "middle disc flange", 0, 1, 1], ["discM", "bottom disc flange", 0, 1, 1]],
    ...
    prismatic1: [["sleeveW", "sleeve width", 0.2, 1.0], ["sleeveLen", "sleeve length", 0.3, 1.5], ["sleeveD", "sleeve depth", 0.2, 1.0], ["ramW", "ram width", 0.1, 0.7], ["ramLen", "ram length", 0.2, 1.5]],
    ball1: [["ballR", "ball radius", 0.15, 0.6], ["socketT", "socket wall", 0.05, 0.25], ["cut", "socket mouth", 0.4, 0.9], ["studR", "stud radius", 0.05, 0.25], ["studLen", "stud length", 0.1, 0.9], ["flangeW", "flange width", 0.4, 1.6], ["disc", "disc flange", 0, 1, 1]],
  };
